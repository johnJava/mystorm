...
public class TotalRankingsBoltTest {
  ...
  @BeforeTest
  public void classloaderforme() throws ClassNotFoundException{
		 Class.forName("storm.starter.bolt.TotalRankingsBolt");   
  }
  ...
  @Test
  public void shouldSetTickTupleFrequencyInComponentConfigurationToNonZeroValue() throws ClassNotFoundException {
    // given
    TotalRankingsBolt bolt = new TotalRankingsBolt();
